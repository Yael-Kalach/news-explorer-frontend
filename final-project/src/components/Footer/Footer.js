      ...
      <div className="footer">
        ...
        <nav className="footer__nav">
          <div className="footer__nav_link-container">
            ...
            <a href='https://practicum.com/en-isr/' className="footer__nav_link">Practicum</a>
          </div>
          <div className="footer__nav_icon-container">
            <a href='https://github.com/Yael-Kalach' className="footer__nav_external footer__nav_link-github">
              <img className="footer__nav_external-icon" src={github} alt='Github icon'/>
            </a>
            <a href='https://www.linkedin.com/in/yael-kalach/' className="footer__nav_external footer__nav_link-linkedin">
